    ...
    <div class="col-sm-4 col-xs-12" style="margin-left:34%; margin-right:40%; margin-top:10%">
      <div class="panel panel-default text-center" >
        ...
        <div class="panel-body">
          <input type="submit" class="btn btn-primary form-control" value="마이페이지 가기" style="background-color:#6495ED" >
          <br>
          <br>
		  <input type="submit" class="btn btn-primary form-control" value="메인페이지 가기" style="background-color:#6495ED" >        
        </div>
